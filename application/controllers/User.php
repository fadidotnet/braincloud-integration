...
class User extends REST_Controller {
	...
	public function get_profile_post()
	{
		...
		if( ! filter_var($session_id, FILTER_VALIDATE_INT) ){
		  $this->response([
		  		'error_code'=>4017,
                'status' => FALSE,
		...
		if(isset($output_profile['ERROR1']))
		$this->set_response(array("error_code"=>4006,"status"=>FALSE,"message"=>$output_profile['ERROR1']), REST_Controller::HTTP_BAD_REQUEST);
		else
