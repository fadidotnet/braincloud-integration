...
|
*/
$config['rest_realm'] = 'GLN Rest API';
...
$config['rest_valid_logins'] = [
								'gameloot' 		=>	AUTH_PASSWORD,
								'bcapp_10703' 	=>	AUTH_PASSWORD,  // Blue yonder
								'bcapp_11007' 	=>	AUTH_PASSWORD,	// Deep Sea Gold Rush
								'bcapp_10642' 	=>	AUTH_PASSWORD,  // Frozen Treat Frenzy
								'bcapp_10346' 	=>	AUTH_PASSWORD,  // Game Loot Network
								'bcapp_10278' 	=>	AUTH_PASSWORD,  // Game Loot Network Rewards
								'bcapp_10347' 	=>	AUTH_PASSWORD,  // Game Loot Network Testing
								'bcapp_10999' 	=>	AUTH_PASSWORD,  // Hungry Ninja
								'bcapp_11240' 	=>	AUTH_PASSWORD,  // Jelly Jump
								'bcapp_10300' 	=>	AUTH_PASSWORD,  // Loot Flyer
								'bcapp_10297' 	=>	AUTH_PASSWORD,  // Ninja Runner Dash
								'bcapp_10674' 	=>	AUTH_PASSWORD,  // Road Battle
								'bcapp_10249' 	=>	AUTH_PASSWORD,  // Round Ball Escape
								'bcapp_11249' 	=>	AUTH_PASSWORD,  // SteamPunk1
								'bcapp_11226' 	=>	AUTH_PASSWORD,  // SteamPunk
								'bcapp_10247' 	=>	AUTH_PASSWORD,  // Trivia Loot
								'bcapp_11285' 	=>	'7EhnVzYn',  	// Eggies (Brain Cloud)
								'bcapp_11281' 	=>	'7EhnVzYn',  	// Eggies APP ID
								'bcapp_eggies' 	=>	'7EhnVzYn'  	// Eggies APP ID
							   ];
...
|
*/
$config['rest_ip_whitelist'] = '198.54.113.185,72.52.205.175,35.166.173.80,203.128.13.121,39.42.128.143,198.54.124.203,198.54.113.66,204.236.224.149';
...
|
*/
$config['rest_keys_table'] = 'gln_api_keys';
...
$exclude_x_methods=["authenticate","get_user_security_key","get_profile","verify_user_security_key"];
$non_x_methods = substr($_SERVER['REQUEST_URI'], strrpos($_SERVER['REQUEST_URI'], '/') + 1);

//echo $non_x_methods;


if(in_array($non_x_methods,$exclude_x_methods))
...
|
*/
$config['rest_key_name'] = 'x-gln-secure-security-token';
...
|
*/
$config['rest_logs_table'] = 'gln_api_logs';
...
|
*/
$config['rest_access_table'] = 'gln_api_access';
...
|
*/
$config['rest_limits_table'] = 'gln_api_limits';
